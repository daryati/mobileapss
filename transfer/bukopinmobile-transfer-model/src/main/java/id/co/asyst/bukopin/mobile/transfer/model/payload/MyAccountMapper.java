...
public class MyAccountMapper {
	...
	public String toString() {
		return "MyAccountMapper [id=" + id + ", accountName=" + accountName
				+ ", accountNo=" + accountNo + ", accountStatus="
				+ accountStatus + ", status=" + status + ", accountType="
				+ accountType + ", cif=" + cif + ", pdId=" + pdId + ", product="
				+ product + ", mainAccount=" + mainAccount + "]";
	}
