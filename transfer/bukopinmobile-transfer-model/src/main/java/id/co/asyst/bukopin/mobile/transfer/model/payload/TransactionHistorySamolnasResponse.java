 ...
 * 
 * @author Gibran Haq
 * @version $Revision$, May 6, 2020
 * @since 1.2.Alpha1
 */
public class TransactionHistorySamolnasResponse {
    /* Constants: */
	...
	return "TransactionHistorySamolnasResponse [date=" + date + ", time=" + time + ", referenceNumber="
		+ referenceNumber + ", accountNumber=" + accountNumber + ", payCode=" + payCode + ", subscriberName="
		+ subscriberName + ", nik=" + nik + ", npkb=" + npkb + ", machineNo=" + machineNo + ", tbpkb=" + tbpkb
		+ ", newTbpkb=" + newTbpkb + ", validityPeriod=" + validityPeriod + ", amount=" + amount + ", adminFee="
		+ adminFee + ", totalAmount=" + totalAmount + ", merk=" + merk + ", type=" + type + ", model=" + model
		+ ", progresif=" + progresif + ", year=" + year + ", alias=" + alias + "]";
    }    
}
