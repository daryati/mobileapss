 ...
 * @since 2.0
 */
public class PaymentCreditCardTibcoReq {
    /* Constants: */

    /* Attributes: */
    IdentityBaseTibco identity;

    PaymentCreditCardBkpTibcoDataReq parameter;
     ...
     */
    public PaymentCreditCardBkpTibcoDataReq getParameter() {
        return parameter;
    }
     ...
     */
    public void setParameter(PaymentCreditCardBkpTibcoDataReq parameter) {
	...
	return "PaymentCreditCardTibcoReq [identity=" + identity + ", parameter=" + parameter + "]";
    }
}
