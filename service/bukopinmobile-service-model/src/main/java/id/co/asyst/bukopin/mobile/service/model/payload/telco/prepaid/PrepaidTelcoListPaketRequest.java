 ...
 */
public class PrepaidTelcoListPaketRequest {
    /* Constants: */

    /* Attributes: */
    private PrepaidTelcoIdentityRequest identity;
    private PrepaidTelcoListPaketDataRequest parameter;
	 ...
	 */
	public PrepaidTelcoListPaketDataRequest getParameter() {
		return parameter;
	}
	/**
	 ...
	 */
	public void setParameter(PrepaidTelcoListPaketDataRequest parameter) {
