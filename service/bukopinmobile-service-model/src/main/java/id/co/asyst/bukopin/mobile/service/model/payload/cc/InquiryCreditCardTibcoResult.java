 ...
 * @since 2.0
 */
public class InquiryCreditCardTibcoResult {
    /* Constants: */

    /* Attributes: */
    IdentityBaseTibco identity;
    
    InquiryCreditCardTibcoDataResp result;
     ...
     */
    public InquiryCreditCardTibcoDataResp getResult() {
        return result;
    }
     ...
     */
    public void setResult(InquiryCreditCardTibcoDataResp result) {
        this.result = result;
    }
	...
	return "InquiryCreditCardTibcoResult [identity=" + identity + ", result=" + result + "]";
    }}
