 ...
 */
public class PrepaidTelcoPurchaseRequest {
    /* Constants: */

    /* Attributes: */
    private PrepaidTelcoIdentityRequest identity;
    private PrepaidTelcoPurchaseDataRequest parameter;
	 ...
	 */
	public PrepaidTelcoPurchaseDataRequest getParameter() {
		return parameter;
	}
	/**
	 ...
	 */
	public void setParameter(PrepaidTelcoPurchaseDataRequest parameter) {
