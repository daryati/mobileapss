 ...
 */
public class PrepaidTelcoListPaketResult {
    /* Constants: */

    /* Attributes: */
    private PrepaidTelcoIdentityRequest identity;
    
    private PrepaidTelcoListPaketDataResponse result;
     ...
     */
    public PrepaidTelcoListPaketDataResponse getResult() {
        return result;
    }
     ...
     */
    public void setResult(PrepaidTelcoListPaketDataResponse result) {
        this.result = result;
    }
