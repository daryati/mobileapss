 ...
 * @since 1.1.Alpha1
 */
public class TelcoPostpaidPaymentTibcoRespayment {
    /* Constants: */

    /* Attributes: */
    private IdentityBaseTibco identity;
    
    private TelcoPostpaidPaymentTibcoDataResult result;
     ...
     */
    public TelcoPostpaidPaymentTibcoDataResult getResult() {
        return result;
    }
     ...
     */
    public void setResult(TelcoPostpaidPaymentTibcoDataResult result) {
        this.result = result;
    }
	...
	return "TelcoPostpaidPaymentTibcoRespayment [identity=" + identity + ", result=" + result + "]";
    }
}
