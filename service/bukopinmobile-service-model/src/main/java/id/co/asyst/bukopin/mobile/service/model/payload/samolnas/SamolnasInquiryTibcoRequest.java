 ...
 * @since 1.2.Alpha1
 */
public class SamolnasInquiryTibcoRequest {
    /* Constants: */

    /* Attributes: */
    private IdentityBaseTibco identity;

    private SamolnasInquiryTibcoDataRequest parameter;
     ...
     */
    public SamolnasInquiryTibcoDataRequest getParameter() {
	return parameter;
    }
     ...
     */
    public void setParameter(SamolnasInquiryTibcoDataRequest parameter) {
	...
	return "SamolnasInquiryTibcoRequest [identity=" + identity + ", parameter=" + parameter + "]";
    }
