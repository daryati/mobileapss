 ...
 */
public class InsurancePurchaseResult {
    /* Constants: */

    /* Attributes: */
    private InsuranceIdentityRequest identity;
    
    private InsurancePurchaseDataResponse result;
     ...
     */
    public InsurancePurchaseDataResponse getResult() {
        return result;
    }
     ...
     */
    public void setResult(InsurancePurchaseDataResponse result) {
        this.result = result;
    }
