 ...
 * @since 2.0
 */
public class TelkomPSTNSpeedyPurchaseTibcoRespayment {
    /* Constants: */

    /* Attributes: */
    private IdentityBaseTibco identity;
    private TelkomPSTNSpeedyPurchaseTibcoDataResp result;
     ...
     */
    public TelkomPSTNSpeedyPurchaseTibcoDataResp getResult() {
        return result;
    }
    /**
     ...
     */
    public void setResult(TelkomPSTNSpeedyPurchaseTibcoDataResp result) {
        this.result = result;
    }
	...
	return "TelkomPSTNSpeedyPurchaseTIbcoRespayment [identity=" + identity + ", result=" + result + "]";
    }
}
