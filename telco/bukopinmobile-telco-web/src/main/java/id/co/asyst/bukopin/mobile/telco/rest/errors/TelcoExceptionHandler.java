 ...
 * license terms.
 */
package id.co.asyst.bukopin.mobile.telco.rest.errors;
...
/**
 * Global Exception Handler for Telco Module
 * 
...
public class TelcoExceptionHandler extends ResponseEntityExceptionHandler {
    private final Logger log = LoggerFactory.getLogger(TelcoExceptionHandler.class);
