...
public class TelcoPostpaidController {
	...
	} else if (ERROR_CODE_BILL_ALREADY_PAID.equals(codeRes) || ERROR_CODE_BILL_NOT_AVAILABLE.equals(codeRes)) {
	...
	CommonResponse verifyPinRes = Services.create(UserModuleService.class).verifyPIN(
		servletRequest.getHeader(HttpHeaders.ACCEPT_LANGUAGE), verifyPinReq)
		.execute().body();
