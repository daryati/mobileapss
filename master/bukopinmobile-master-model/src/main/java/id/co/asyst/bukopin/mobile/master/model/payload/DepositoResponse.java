...
public class DepositoResponse {
    ...
    /* Attributes: */
    private List<DepositoDetailResponse> depositoList;

	public List<DepositoDetailResponse> getDepositoList() {
		return depositoList;
	}

	public void setDepositoList(List<DepositoDetailResponse> depositoList) {
