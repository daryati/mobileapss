 ...
 * @since 1.1.Alpha1
 */
public class DepositoDetailResponse {
    /* Constants: */
	...
	@JsonProperty("rate")
    private List<RateDepositoResponse> rateList;
	...
	public List<RateDepositoResponse> getRateList() {
		return rateList;
	}

	public void setRateList(List<RateDepositoResponse> rateList) {
