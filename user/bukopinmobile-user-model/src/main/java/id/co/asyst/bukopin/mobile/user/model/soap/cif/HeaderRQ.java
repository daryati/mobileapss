...
public class HeaderRQ {
	...
	return "HeaderRQ [reqDateTime=" + reqDateTime + ", clientTxnID=" + clientTxnID + ", isLastTxn=" + isLastTxn
    ...
    public static class Credentials {
        ...
        @XmlElement(name = "ClientID", namespace = "http://xml.asyst.co.id/commons/ws/header", required = true)
	...
	@Override
	public String toString() {
	    return "Credentials [clientID=" + clientID + ", identity=" + identity + ", session=" + session + "]";
	}
	...
	/**
        ...
        public static class Identity {
            ...
            @XmlElement(name = "UserID", namespace = "http://xml.asyst.co.id/commons/ws/header", required = true)
            protected String userID;
            @XmlElement(name = "Password", namespace = "http://xml.asyst.co.id/commons/ws/header", required = true)
